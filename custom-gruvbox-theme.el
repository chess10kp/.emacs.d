...
(def-doom-theme custom-gruvbox
                "Dark theme with pastel 'retro groove' colors."

                ;; name        gui       256       16
                ((bg
                  (cond ((equal doom-gruvbox-dark-variant "hard") '("#0e1419" "#0e1419" nil))   ; bg0_h
                        ((equal doom-gruvbox-dark-variant "soft") '("#0e1419" "#0e1419" nil))   ; bg0_s
                        (t                                        '("#0e1419" "#0e1419" nil)))) ; bg0
                 (bg-alt
                  (cond ((equal doom-gruvbox-dark-variant "hard") '("#0e1419" "black" nil))     ; (self-defined)
                        ((equal doom-gruvbox-dark-variant "soft") '("#0e1419" "#0e1419" nil))   ; bg0
                        (t                                        '("#0e1419" "#0e1419" nil)))) ; bg_h
                 (bg-alt2    '("#504945" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

                 (base0      '("#0d1011" "black"   "black"      )) ; (self-defined)
                 (base1      '("#0e1419" "#0e1419" "brightblack")) ; bg0_h
                 (base2      '("#0e1419" "#0e1419" "brightblack")) ; bg0
                 (base3      '("#0e1419" "#0e1419" "brightblack")) ; bg1
